                    ...
                    case "play a card game":
                        {
                            ...
                            Console.WriteLine("The Cards Will Now Be Shuffled and Dealed to Four Random Reviewers....Let's Pick Them!");
                            ...
                            MySqlDataReader rdr2;
                            MySqlCommand cmd1;
                            string randomReviewer = "Select first from RestaurantReviewers ORDER BY Rand() LIMIT 1;";
                            ...
                            try
                            {
                                ...
                                cmd1 = new MySqlCommand(randomReviewer, conn2);
                                rdr2 = cmd1.ExecuteReader();
                                ...
                                while (rdr2.Read())
                                {
                                    ...
                                    player1 = rdr2["first"].ToString() as string;
                            ...
                            try
                            {
                                ...
                                while (rdr2.Read())
                                {
                                    ...
                                    player2 = rdr2["first"].ToString() as string;
                            ...
                            try
                            {
                                ...
                                while (rdr2.Read())
                                {
                                    ...
                                    player3 = rdr2["first"].ToString() as string;
                            ...
                            try
                            {
                                ...
                                while (rdr2.Read())
                                {
                                    ...
                                    player4 = rdr2["first"].ToString() as string;
                            ...
                            Console.Clear();
                            Console.WriteLine("Here our the players of the game...");
                            Console.WriteLine("Player 1: " + player1+"-------"+ "Player 2: "+ player2+"-------"+"Player 3: "+ player3+"------"+"Player 4: "+ player4+ "\n\n");
                        }
                        Console.ReadKey();
                        //deal cards
                        Console.WriteLine(player1+"'s cards:");

                        Deck newDeck = new Deck();
                        newDeck.Shuffle();
                        for (int counter = 0; counter < 13; counter++)
                        {
                            Console.WriteLine(newDeck.DealCard());
                        

                        }
                        Console.WriteLine("");
                        Console.WriteLine(player2 + "'s cards:");
                        ...
                        Console.WriteLine("");
                        Console.WriteLine(player3 + "'s cards:");
                        ...
                        Console.WriteLine("");
                        Console.WriteLine(player4 + "'s cards:");
